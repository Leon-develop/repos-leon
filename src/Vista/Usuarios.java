...
DefaultTableModel modelo;
   ...
   String sql="SELECT * FROM  usuario"; 
    ...
    private void initComponents() {
        ...
        btnaceptar.setFont(new java.awt.Font("Dialog", 0, 12)); // NOI18N
...
// TODO add your handling code here:
    ...
    else
    {
         ...
         JOptionPane.showMessageDialog(this, "Debe Ingresar la Contraseña para Eliminar un Usuario");
...
// TODO add your handling code here:
    ...
    String sql="SELECT * FROM usuario WHERE usuario='"+cap+"'";
     ...
     DesktopNotify.showDesktopMessage("Información","Se eliminó un registro", DesktopNotify.SUCCESS, 4000L);
                ...
                {
                    JOptionPane.showMessageDialog(this, "No se pudo eliminar porque la contraseña no coincide");
                    mostrarusuarios();
                }
